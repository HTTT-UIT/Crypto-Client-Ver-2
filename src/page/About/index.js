...
const AboutPage = () => {
  return (
    <>
      ...
      <Box bg="rgba(255,206,140,0.5)">
        <Flex m={"12px 12px 0 12px"} p="5" justifyContent={"center"} gap="5">
          <Image
            bg={"white"}
            rounded={'lg'}
            height={142}
            ...
            objectFit={'cover'}
            shadow="2xl"
            src={"https://www.tahasivaci.com/wp-content/uploads/2022/06/vs-2022.png"}
            />
          <Image
            bg={"white"}
            rounded={'lg'}
            ...
            objectFit={'contain'}
            shadow="2xl"
            src={"https://images.fpt.shop/unsafe/filters:quality(90)/fptshop.com.vn/uploads/images/tin-tuc/146213/Originals/visual-studio-code_jpg.jpg"}
            />
          <Image
            bg={"white"}
            rounded={'lg'}
            ...
            objectFit={'contain'}
            shadow="2xl"
            src={"https://images.careerbuilder.vn/content/images/figma-la-gi-CareerBuilder-1.png"}
            />
        </Flex>
        <Flex p="5" justifyContent={"center"} gap="5">
          <Image
            ...
            objectFit={'contain'}
            shadow="2xl"
            src={"https://docs.yepcode.io/img/logos/integrations/github.png"}
            />
          <Image
            bg={"white"}
            rounded={'lg'}
            ...
            objectFit={'contain'}
            shadow="2xl"
            src={"https://cms.rootstack.com/sites/default/files/inline-images/Jira-new-logo_0.png"}
            />
          <Image
            bg={"white"}
            rounded={'lg'}
